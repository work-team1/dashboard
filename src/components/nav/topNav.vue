  ...
  <el-row class="container">
    ...
    <el-col :span="24" class="topbar-wrap">
      ...
      <div class="topbar-logos">
        <a href="/" style="color: #fff;"><span v-show="!$store.state.collapsed">DashBoard</span></a>
      </div>
        ...
        <el-row v-show="$store.state.topNavState==='home'">
          <el-col :span="24">
            <el-menu :default-active="defaultActiveIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect" :router="true">
              ...
              <el-menu-item index="/gatewayManager">Gateways</el-menu-item>
              <el-menu-item index="/orderManager">Devices</el-menu-item>
              <el-menu-item index="/systemManager">Settings</el-menu-item>
            </el-menu>
          </el-col>
        </el-row>
      ...
      <div class="topbar-account topbar-btn">
        <el-dropdown trigger="click">
          ...
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item>
              <div @click="jumpTo('/user/profile')"><span style="color: #555;font-size: 14px;">PI</span></div>
            </el-dropdown-item>
            <el-dropdown-item>
              <div @click="jumpTo('/user/changepwd')"><span style="color: #555;font-size: 14px;">ChangePassword</span></div>
            </el-dropdown-item>
